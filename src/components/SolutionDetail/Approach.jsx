...
const Approach = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-screen h-screen sticky top-0 z-[20] industry-container ">
        <div className="w-fit h-fit absolute right-[-5%] top-[20%] industry-1-container">
        ...
        <div className="w-fit h-fit absolute right-[-5%] translate-x-[120%] top-[20%] industry-2-container">
          <div className="flex items-start justify-between w-[55vw]">
            <div className=" w-[25vw] h-[15vw]" style={{perspective:"30rem"}}>
              <Image
                src={"/assets/images/homepage/industries/fintech.png"}
        ...
        <div className="w-fit h-fit absolute right-[-5%] translate-x-[240%] top-[20%] industry-3-container">
          <div className="flex items-start justify-between w-[55vw]">
            <div className=" w-[25vw] h-[15vw]" style={{perspective:"30rem"}}>
              <Image
                src={"/assets/images/homepage/industries/fintech.png"}
